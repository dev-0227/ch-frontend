        ...
        render: function (data, type, row) {
          return `
            <div class="btn-group align-top" idkey="`+row.id+`">
              ...
              <button organizationkey="`+row.oragnization+`" class="btn btn-sm btn-warning managerorganizationbtn ${$("#specialist_organization").attr('class')}" data-permit="SPECIALIST_ORGAN_ASSOCIATE" type="button"><i class="fa fa-solid fa-hotel">
